...
namespace Web.Controllers
{
    ...
    public class FournisseurController : Controller
    {
        ...
        public FournisseurController(IFournisseurService fournisseurService, UserManager<ApplicationUser> userManager, IGestionMouvementService gestionMouvementService, IZoneStockageService zoneStockageService, IHostingEnvironment environment)
        {
...
;
        ...
        public async Task<IActionResult> ListePaiementFactures(int? id)
        {
            var Id = Convert.ToInt32(HttpContext.User.FindFirst("AboId").Value);
            var query = await fournisseurService.getListPayementFacture((int)id, Id);
            ...
            if (HttpContext.Request.Form.Files != null)
            {
                ...
                foreach (var file in files)
                {
                    if (file.Length > 0)
                    {
                        ...
                        distributeurModel.Distributeur_Photo = PathDB;
